...
#The program shuld read three integers. the number of students in each of the three classes, a , b and c respectivelyl
...
x=int(input("Enter the no student in first class:))
y=int(input("Enter the no student in second class:))
z=int(input("Enter the no student in third class:))
